...
function MonitoringHome() {
  ...
  const apiURL = "api/instances/readallinstances";
  ...
  const searchHandler = (event) => {
    ...
    const url = "api/instances/readoneinstancesbyparams";
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell size="medium">
                        {" "}
                        <Typography variant="h7">FirstName</Typography>{" "}
                      </TableCell>
                      <TableCell size="medium">
                        {" "}
                        <Typography variant="h7">LastName</Typography>{" "}
                      </TableCell>
                      <TableCell size="medium">
                        {" "}
                        <Typography variant="h7">ContactNo</Typography>{" "}
                      </TableCell>
                      <TableCell size="medium">
                        {" "}
                        <Typography variant="h7">EmailId</Typography>{" "}
                      </TableCell>
                      <TableCell size="medium">
                        {" "}
                        <Typography variant="h7">WorkflowName</Typography>{" "}
                      </TableCell>
                      ...
                      <TableCell size="medium">
                        {" "}
                        <Typography variant="h7">EntryDate</Typography>{" "}
                      </TableCell>
                      <TableCell size="medium">
                        {" "}
                          ...
                          <TableRow key={item._id}>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                setIdd(item._id);
                                console.log(
                                  "Instance view item._id:" + item._id
                                );
                              }}
                              fullWidth="false"
                            >
