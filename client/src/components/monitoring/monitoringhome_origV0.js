...
Table,TableRow,TableBody,TableCell,TableContainer,Paper,Avatar,Grid} from '@material-ui/core';
    ...
    <Paper elevation= {2} variant="outlined"  >
        ...
        <center>
            <FormControl>
                ...
                <Button variant="contained" onClick = {searchHandler}  type="submit">Search</Button>
                <br/>
            </FormControl>
            </center>
            </Paper>
