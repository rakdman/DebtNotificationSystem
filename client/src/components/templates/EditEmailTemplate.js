...
function getData () {
    ...
    axios.get(`http://${process.env.REACT_APP_SERVER_IP_PORT}/api/template/readoneemailtemplate`,{params:{idd:idd}}).then(
...
// update data
 saveHandler = event => {
    ...
    axios.patch(`http://${process.env.REACT_APP_SERVER_IP_PORT}/api/template/updateemailtemplate`,{idd:idd, tname:templateName,text:templateText}).then(res => { console.log(res.data); });
...
return(
    ...
    <React.Fragment>
        ...
        <FormControl onSubmit={submitHandler} size="medium">
            ...
            <br/>
            <ButtonGroup> 
            <Button variant="contained"  size= "small"  color="primary" onClick={saveHandler}>Save</Button>
