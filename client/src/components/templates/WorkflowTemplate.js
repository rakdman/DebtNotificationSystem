...
import { FormControl,TextField, TextareaAutosize, Button,Typography,ButtonGroup,
Table,TableBody,TableRow,TableCell,Paper} from '@material-ui/core';
...
const onSubmit = event => {
    ...
    // axios.post(`http://localhost:9090/api/workflow/create`,{wfname:wfname,wfsteps:[{NWait:number1,NName:select1},{NWait:number2,NName:select2},{NWait:number3,NName:select3},{NWait:number4,NName:select4},{NWait:number5,NName:select5}]})
    axios.post(`http://${process.env.REACT_APP_SERVER_IP_PORT}/api/workflow/create`,{wfname:event.wfname,wfsteps:steps})
...
const addNewHandler = event => {
 ...
 const [templateArray,setTemplateArray]  = useState();
    ...
    // const apiURL = "http://localhost:9090/api/template/readalltemplates";   // This API to populate the SMS templates
    const apiURL = "http://"+process.env.REACT_APP_SERVER_IP_PORT+"/api/template/emailtemplates";
...
return(
    ...
    <React.Fragment>
        ...
        <FormControl size="medium">
            ...
            <TextField  label= "Workflow Name" variant="outlined" type="Text" {...register("wfname",{required: "Input required", maxLength : { value: 50, message: "Maximum 50 characters"}})}/>
           ...
           <Table>
                <TableBody>
                    <TableRow>
                        <TableCell>
                            <Typography variant="subtitle1">Trigger After Duration</Typography>
                        </TableCell>
                        <TableCell>
                        <Typography variant="subtitle1">Notification Template</Typography>
                        </TableCell>
                    </TableRow>
                    {/* {smsTemp && smsTemp.map((item,index)=> {array.push(item.tname)})} */}
                    {smsTemp && smsTemp.map((item,index)=> {array.push(item.text)})}
                    <TableRow>
                        <TableCell>
                            {/* <TextField label= "Number" value={number1} onChange={(e)=>{setNumber1(e.target.value)}}></TextField> */}
                            <TextField label= "Number" {...register("number1",{required: "Input required",  min: {value:0, message:"Minimum must be at least 0 days"},  max: {value:360, message:"Maximum allowed is 360 days"}} )} />
                        ...
                        <TableCell>
                            <Autocomplete 
                                ...
                                options={array}
                                renderInput={(params) => <TextField {...params} label="Select Template" variant="outlined" {...register("select1",{required: "Input required"})} />}
                            />
                    ...
                    <TableRow>
                        <TableCell>
                            ...
                            <TextField label= "Number" {...register("number2",{ min: {value:0, message:"Minimum must be at least 0 days"},  max: {value:360, message:"Maximum allowed is 360 days"}} )} />
                        ...
                        <TableCell>
                            <Autocomplete 
                                ...
                                options={array}
                                renderInput={(params) => <TextField {...params} label="Select Template" variant="outlined" {...register("select2")} />}
                    ...
                    <TableRow>
                        <TableCell>
                            ...
                            <TextField label= "Number" {...register("number3",{min: {value:0, message:"Minimum must be at least 0 days"},  max: {value:360, message:"Maximum allowed is 360 days"}} )} />
                        ...
                        <TableCell>
                            <Autocomplete 
                                ...
                                options={array}
                                renderInput={(params) => <TextField {...params} label="Select Template" variant="outlined" {...register("select3")} />}
                    ...
                    <TableRow>
                        <TableCell>
                            ...
                            <TextField label= "Number" {...register("number4",{  min: {value:0, message:"Minimum must be at least 0 days"},  max: {value:360, message:"Maximum allowed is 360 days"}} )} />
                        ...
                        <TableCell>
                            <Autocomplete 
                                ...
                                options={array}
                                renderInput={(params) => <TextField {...params} label="Select Template" variant="outlined" {...register("select4")} />}
                    ...
                    <TableRow>
                        <TableCell>
                            ...
                            <TextField label= "Number" {...register("number5",{ min: {value:0, message:"Minimum must be at least 0 days"},  max: {value:360, message:"Maximum allowed is 360 days"}} )} />
                        ...
                        <TableCell>
                            <Autocomplete 
                                ...
                                options={array}
                                renderInput={(params) => <TextField {...params} label="Select Template" variant="outlined" {...register("select5")} />
           ...
           <Button color="primary"  size= "small"  variant="contained" fullWidth="false" onClick= {handleSubmit(onSubmit)} >Save</Button>
           <br/><br/>
        </FormControl>
