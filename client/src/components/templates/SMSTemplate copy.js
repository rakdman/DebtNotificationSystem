...
const saveHandler = event => {
    ...
    axios.post(`http://localhost:9090/api/template/create`,{tname:event.templateName,text:event.templateText}).then(res => { console.log(res.data); });
...
return(
    ...
    <React.Fragment>
        ...
        <FormControl onSubmit={submitHandler} size="medium">
            ...
            <Button variant="contained" onClick={handleSubmit(saveHandler)}>Save</Button>
