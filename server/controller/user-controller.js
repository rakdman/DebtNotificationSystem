...
const updateUser = async (req, res, next) => {
  ...
  if (requsername === "rakdman") reqapproved = "true";

  // console.log(requsername)
  // console.log(reqapproved)
  const readUserData = await Usertemplatemodel.find({
...
const checkUser = async (req, res, next) => {
  ...
  console.log(username);
  console.log(email);
  var result = await Usertemplatemodel.find({
